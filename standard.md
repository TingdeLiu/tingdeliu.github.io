...
**Tags 选取原则**：
- 优先使用已有 tag（如 `VLN`、`VLA`、`VLM`·`Robotics`、`Deep Learning`、`Computer Vision`）
- 补充该领域特有的细分 tag（如 `SLAM`、`Navigation`、`Manipulation`）
