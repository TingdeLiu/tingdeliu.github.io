...
# 4. Cosmos：物理AI世界基础模型平台 (2025–2026)
...
<figcaption>Cosmos-Transfer2.5 vs Transfer1-7B 效果对比：Transfer2.5 在 Prompt 对齐（prompt alignment）、错误累计（hallucination & error accumulation）、控制信号遵循（adherence to control input）三项上均优于前代，且模型尺寸缩小 3.5×。（图源：Cosmos-Predict2.5）</figcaption>
</div>
