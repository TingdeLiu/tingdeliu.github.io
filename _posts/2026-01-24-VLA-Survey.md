...
| 模型 | 发布时间 | 参数规模 | 视觉编码器 | 动作解码范式 | 核心特点 | 开源状态 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **RT-1** | 2022.12 | 130M | EfficientNet | 离散 Token 化 | 首个大规模真实世界 Transformer 策略 | ✅ 模型+数据 |
| **RT-2** | 2023.07 | 5B/55B | PaLI-X / ViT | 离散 Token 化 | 首次实现 VLM 到 VLA 的知识迁移 | ❌ 闭源 |
| **OpenVLA** | 2024.06 | 7B | SigLIP + DINOv2 | 离散 Token 化 | 目前最强开源 VLA，支持 LoRA 微调 | ✅ 模型+代码 |
| **π₀** | 2024.10 | 3.8B | SigLIP | **Flow Matching** | 50Hz 高频控制，支持灵巧操作 | ✅ 权重+代码 |
| **π₀.5** | 2025.04 | - | 多视角融合 | Flow Matching | 开放世界家庭长时程任务泛化 | ❌ 商业闭源 |
| **ACoT-VLA** | 2026.01 | - | VLM 增强 | **动作空间推理** | 显著减少误差累积，提升长时域稳定性 | 📄 仅论文 |
