...
| [GA-VLN](#ga-vln) | 2026 | R2R-CE | 61.0 | 55.2 | 4.80 | 67.6 | 代码与模型权重已开源 |
...
| [GA-VLN](#ga-vln) | 2026 | RxR-CE | 55.4 | 45.2 | 5.88 | 67.0 | 代码与模型权重已开源 |
...
54. **GA-VLN** (2026). Geometry-Aware BEV Representation for Efficient Vision-Language Navigation. arXiv: [2605.22036](https://arxiv.org/abs/2605.22036)
...
(function () {
  var TAG_MAP = [
    ...
    { m: 'LangSplatV2',       t: ['高斯表示', '加速优化', '基础工作'] },
        ...
        { m: 'GA-VLN',                t: ['Agent', '连续环境', '实机部署', '加速优化'] },
