...
📄 **Paper**: [arXiv:2605.22816](https://arxiv.org/abs/2605.22816) · [Project Page](https://gwxuan.github.io/AwareVLN/)
...
📄 **Paper**: [arXiv:2509.22548v2](https://arxiv.org/abs/2509.22548v2)
...
## 46. OneVLA: A Unified Framework for Embodied Tasks (2026) {#onevla-a-unified-framework-for-embodied-tasks}
...
## 50. RynnBrain: Open Embodied Foundation Models (2026) {#rynnbrain}
...
## 53. OmniNav: A Unified Framework for Prospective Exploration and Visual-Language Navigation (2026) {#omninav}
———用快慢双系统统一点目标、物体目标、指令目标导航与前沿探索

📄 **Paper**: https://arxiv.org/abs/2509.25687
...
## 54. AstraNav-World: World Model for Foresight Control and Consistency (2025) {#astranav-world}
...
14. **VLingNav** (2026). [Project Page](https://wsakobe.github.io/VLingNav-web/)
15. **Slow4fast-VLN** (2026). arXiv: [2601.09111](https://arxiv.org/abs/2601.09111)
16. **FantasyVLN** (2026). arXiv: [2601.13976](https://arxiv.org/abs/2601.13976)
17. **VL-Nav** (2025). arXiv: [2502.00931](https://arxiv.org/abs/2502.00931)
18. **StreamVLN** (2025). arXiv: [2507.05240](https://arxiv.org/abs/2507.05240)
19. **NavFoM** (2025). arXiv: [2509.12129](https://arxiv.org/abs/2509.12129)
20. **DGNav** (2026). arXiv: [2601.21751](https://arxiv.org/abs/2601.21751)
21. **MapNav** (2025). arXiv: [2502.13451](https://arxiv.org/abs/2502.13451)
22. **Hydra-Nav** (2026). arXiv: [2602.09972](https://arxiv.org/abs/2602.09972)
23. **3DGSNav** (2026). 3D Gaussian Splatting-Based Navigation. arXiv: [2602.12159](https://arxiv.org/abs/2602.12159)
24. **BudVLN** (2026). arXiv: [2602.06356](https://arxiv.org/abs/2602.06356)
25. **Open-Nav** (2025). arXiv: [2409.18794](https://arxiv.org/abs/2409.18794)
26. **CausalNav** (2026). arXiv: [2601.01872](https://arxiv.org/abs/2601.01872)
27. **SparseVideoNav** (2026). arXiv: [2602.05827](https://arxiv.org/abs/2602.05827)
28. **AgentVLN** (2026). arXiv: [2603.17670](https://arxiv.org/abs/2603.17670)
...
34. **VLN-PE** (2025). Vision-Language Navigation in Physical Embodied Environments. arXiv: [2507.13019](https://arxiv.org/abs/2507.13019)
35. **RynnBrain** (2026). Open Embodied Foundation Models. arXiv: [2602.14979](https://arxiv.org/abs/2602.14979)
36. **LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS** (2025). 彻底告别解码器：基于稀疏系数场的超高速 3D 语言场. arXiv: [2507.07136](https://arxiv.org/abs/2507.07136)
37. **OpenGaussian** (2024). 迈向点云级 3D Gaussian 开放词汇理解. arXiv: [2406.02058](https://arxiv.org/abs/2406.02058)
38. **LingBot-World: Advancing Open-source World Models** (2026). 首个开源、支持实时交互的长程世界模型. arXiv: [2601.20540](https://arxiv.org/abs/2601.20540)
...
40. **WorldVLN** (2025). Autoregressive World Action Model for Aerial Vision-Language Navigation. arXiv: [2605.15964](https://arxiv.org/abs/2605.15964)
41. **AwareVLN** (2026). Reasoning with Self-awareness for Vision-Language Navigation. arXiv: [2605.22816](https://arxiv.org/abs/2605.22816)
42. **Dual-Anchoring** (2026). 用"指令进度"与"地标记忆"双重锚定，对抗 VLN 中的状态漂移（State Drift）. arXiv: [2604.17473](https://arxiv.org/abs/2604.17473)
43. **LoGoPlanner** (2025). Localization Grounded Navigation Policy with Metric-aware Visual Geometry. arXiv: [2512.19629](https://arxiv.org/abs/2512.19629)
44. **WAM-Nav** (2026). 非对称隐空间「世界-动作」联合建模，用一个 DiT 统一三类视觉导航. arXiv: [2606.04907](https://arxiv.org/abs/2606.04907)
45. **JanusVLN** (2026). 解耦语义与空间：使用双隐式神经内存的视觉语言导航. arXiv: [2509.22548](https://arxiv.org/abs/2509.22548)
...
51. **OmniNav: A Unified Framework for Prospective Exploration and Visual-Language Navigation** (2026). 用快慢双系统统一点目标、物体目标、指令目标导航与前沿探索. arXiv: [2509.25687](https://arxiv.org/abs/2509.25687)
52. **AstraNav-World: World Model for Foresight Control and Consistency** (2025). 将"想象未来"与"规划未来"统一进同一个生成式概率框架. arXiv: [2512.21714](https://arxiv.org/abs/2512.21714)
53. **ABot-N0** (2026). 统一具身导航的"大脑-行动"VLA基础模型：5大任务、16.9M轨迹、Agentic部署. arXiv: [2602.11598](https://arxiv.org/abs/2602.11598)
54. **Qwen-RobotNav** (2026). 首个统一的多任务、时空可重构具身导航大模型.
...
(function () {
  var TAG_MAP = [
    ...
    { m: 'LangSplatV2',       t: ['高斯表示', '加速优化', '基础工作'] },
        ...
        { m: 'OmniNav: A Unified Framework for Prospective Exploration and Visual-Language Navigation', t: ['双系统', 'Agent', '扩散模型', '实机部署'] },
        { m: 'AstraNav-World: World Model for Foresight Control and Consistency', t: ['世界模型', '扩散模型', '端到端', '连续环境', '实机部署'] },
        { m: 'ABot-N0',               t: ['Agent', '端到端', '拓扑图', '强化学习', '连续环境', '实机部署'] },
        { m: 'Qwen-RobotNav',         t: ['Agent', '端到端', '连续环境', '实机部署'] },
