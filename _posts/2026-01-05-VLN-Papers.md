...
(function () {
  var TAG_MAP = [
    ...
    { m: 'NavDP',             t: ['扩散模型', '3D表示', '连续环境', '零样本', '实机部署'] },
    { m: 'NoMaD',             t: ['扩散模型', '零样本', '实机部署'] },
    { m: 'ODYSSEY',           t: ['LLM推理', '实机部署'] },
    { m: 'PanoNav',           t: ['LLM推理', '零样本', '离散环境'] },
    { m: 'VLN-R1',            t: ['LLM推理', '强化学习', '连续环境'] },
    { m: 'LagMemo',           t: ['3D表示', '离散环境'] },
    { m: 'GaussNav',          t: ['3D表示'] },
    { m: 'VLFM',              t: ['零样本', '实机部署'] },
    { m: 'Motus',             t: ['扩散模型', '世界模型', '强化学习'] },
    { m: 'NavGPT-2',          t: ['LLM推理', '图结构', '离散环境'] },
    { m: 'NavGPT',            t: ['LLM推理', '零样本', '离散环境'] },
    { m: 'FSR-VLN',           t: ['双系统', '图结构', '实机部署'] },
    { m: 'VLingNav',          t: ['双系统', '连续环境'] },
    { m: 'Slow4fast-VLN',     t: ['双系统', '图结构', '离散环境'] },
    { m: 'FantasyVLN',        t: ['世界模型', '数据增强', '连续环境'] },
    { m: 'VL-Nav',            t: ['零样本', '实机部署'] },
    { m: 'StreamVLN',         t: ['加速优化', '连续环境', '实机部署'] },
    { m: 'NavFoM',            t: ['LLM推理', '连续环境'] },
    { m: 'DGNav',             t: ['图结构', '连续环境'] },
    { m: 'MapNav',            t: ['LLM推理', '图结构', '加速优化', '连续环境'] },
    { m: 'Hydra-Nav',         t: ['双系统', '强化学习'] },
    { m: '3DGSNav',           t: ['3D表示', '零样本', '实机部署'] },
    { m: 'BudVLN',            t: ['强化学习', '连续环境'] },
    { m: 'Open-Nav',          t: ['LLM推理', '零样本', '连续环境'] },
    { m: 'CausalNav',         t: ['LLM推理', '图结构'] },
    { m: 'SparseVideoNav',    t: ['扩散模型', '世界模型'] },
    { m: 'AgentVLN',          t: ['LLM推理', '连续环境', '实机部署'] },
    { m: 'RoboClaw',          t: ['LLM推理'] },
    { m: 'Skill-Nav',         t: ['强化学习', '实机部署'] },
    { m: 'VLN-Cache',         t: ['加速优化'] },
    { m: 'SysNav',            t: ['LLM推理', '图结构'] },
    { m: 'VLN-Imagine',       t: ['数据增强', '离散环境'] },
    { m: 'Diffusion Policy',  t: ['扩散模型', '基础工作'] },
    { m: 'Lumina-Next',       t: ['扩散模型', '基础工作'] },
    { m: 'Qwen3-VL',          t: ['LLM推理', '基础工作'] },
    { m: 'VLN-CE',            t: ['连续环境', '基础工作'] },
    { m: 'VLN-PE',            t: ['连续环境', '基础工作'] },
    { m: 'InternVLA-A1',      t: ['世界模型', '基础工作'] },
    { m: 'InternData-A1',     t: ['数据增强', '基础工作'] },
    { m: 'RynnBrain',         t: ['LLM推理', '基础工作'] },
    { m: 'Janus-Pro',         t: ['世界模型', '基础工作'] },
    { m: 'Video Generation',  t: ['世界模型', '基础工作'] }
  ];

  var ALL_TAGS = ['双系统', '扩散模型', 'LLM推理', '3D表示', '图结构', '强化学习',
                  '零样本', '世界模型', '数据增强', '连续环境', '离散环境',
                  '实机部署', '加速优化', '基础工作'];
