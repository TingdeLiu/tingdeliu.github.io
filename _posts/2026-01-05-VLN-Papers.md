...
author: Tingde Liu
toc: true
excerpt: "本文系统梳理VLN领域的经典论文与基石论文，涵盖DualVLN、InternVLN等最新研究成果，以及Diffusion Policy等奠定VLN/VLA领域基础的重要工作。"
---

> 本文是 [VLN综述：基于视觉语言的导航](/VLN-Survey/) 的配套论文精读，收录 VLN 经典论文与领域基石论文。
...
📄 **Paper**: [arXiv:2412.10371](https://arxiv.org/abs/2412.10371)   🛖**代码仓库**：https://github.com/wzzheng/GaussianAD
