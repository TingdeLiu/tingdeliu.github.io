...
**Qwen2.5-VL** 通过 3D-RoPE 和动态帧率采样支持数十分钟的超长视频；**Qwen3-VL** 进一步以显式文本时间戳与 Interleaved MRoPE 将多模态上下文扩展到 256K（30分钟视频内 Needle-in-a-Haystack 100% 准确率，见 7.9 节）。
