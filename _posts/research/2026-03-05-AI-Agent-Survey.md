...
| 属性 | 内容 |
|------|------|
| 发布年份 | 2025（2026 年中大范围流行） |
| 规模 | 涵盖机票预订、零售等多行业复杂业务数据库 |
| 场景 | 模拟真实企业多轮 API 对话及多重数据库冲突 |
| 特点 | 评测 Agent 解决实际商业业务流程、应对报错故障和恢复（Recovery）的能力 |

小规模的 API 交互极易测试，但 τ-bench 是 2026 年最流行的业务级工具调用评测基准，重点关注智能体在多步骤业务流程中，遇到偏离预期的 API 响应时的故障诊断与自我恢复能力。
...
在 Loop Engineering 闭环设计大行其道的 2026 年中后期，STATE-Bench 成为衡量 Agent 会话连续性与外部 State 记忆交互效率的黄金基准。

---

### 细分专业基准 (ReactBench & KernelBench)

随着 Agent 在专业工程师团队中进一步落地，2026 年中涌现了垂直领域的定制化基准：
...
伴随着 2026 年中 AI Agent 进入完全生产环境，评测哲学完成了从“黑盒最终状态判定（Pass/Fail）”到“执行轨迹与多维质量分析（Trajectory & Performance Analysis）”的进化。目前行业主流（如 LangSmith、Braintrust 等）统一围绕以下三大支柱开展工程测评：
